     ...
     <div className='text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
        ...
        <h1 className="sm:block text-xl md:text-2xl font-bold text-gray-700">BANARAS TOUR</h1>
                    ...
                    <p className='text-sm mt-4'>
                        Experience the spiritual heart of India with Banaras Tour. We provide the most authentic cultural experiences, heritage walks, and boat rides to make your journey unforgettable.
                    </p>
                ...
                <div className='max-w-80'>
                    ...
                    <p className='mt-3 text-sm'>
                        Subscribe to get exclusive offers and updates about new tours.
                    </p>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5 text-sm'>
                <p>© {new Date().getFullYear()} Aviansh Saini. All rights reserved.</p>
                <ul className='flex items-center gap-4'>
                    <li><a className='text-gray-400 bg-white' href="#">Privacy</a></li>
